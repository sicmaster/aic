...
export function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen bg-canvas px-4 py-8 text-ink lg:grid-cols-[minmax(0,0.95fr)_minmax(420px,0.55fr)] lg:px-8">
      ...
      <section className="flex items-center justify-center">
        <div className="w-full max-w-md rounded-md border border-border bg-panel p-6 shadow-sm">
          <div className="mb-6">
